...
public class Cwh_01_ArrayList {
    public static void main(String[] args) {
        ...
        // We can add initial capacity in the ArrayList<>(here)
        ...
        // l1.add() to append elements at the end of the ArrayList
        ...
        for (int i = 0; i < l1.size(); i++) { // l1.size() to get arraylist size
        ...
        System.out.println("Is l2 empty ? Ans : "+l2.isEmpty()); // returns boolean whether or not the array list is empty

        l1.getFirst(); // get first element of the array list
        l1.getLast(); // get last element of the array list
